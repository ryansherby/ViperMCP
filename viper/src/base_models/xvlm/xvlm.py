...
from viper.src.base_models.xvlm.vit import VisionTransformer, interpolate_pos_embed
from viper.src.base_models.xvlm.swin_transformer import SwinTransformer, interpolate_relative_pos_embed
from viper.src.base_models.xvlm.xbert import BertConfig, BertForMaskedLM, BertModel

from viper.configs import config as viper_config
...
def build_text_encoder(config, vision_width, load_text_params=False, use_mlm_loss=False, config_text=None):
    ...
    config_text = BertConfig.from_json_file(viper_config.root + '/src/base_models/xvlm/config_bert.json')
