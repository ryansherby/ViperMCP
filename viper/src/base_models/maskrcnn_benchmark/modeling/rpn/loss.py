...
from viper.src.base_models.maskrcnn_benchmark.layers import smooth_l1_loss
from viper.src.base_models.maskrcnn_benchmark.modeling.matcher import Matcher
from viper.src.base_models.maskrcnn_benchmark.structures.boxlist_ops import boxlist_iou
from viper.src.base_models.maskrcnn_benchmark.structures.boxlist_ops import cat_boxlist
from viper.src.base_models.maskrcnn_benchmark.layers import SigmoidFocalLoss, IOULoss, TokenSigmoidFocalLoss
from viper.src.base_models.maskrcnn_benchmark.utils.comm import get_world_size, reduce_sum
from viper.src.base_models.maskrcnn_benchmark.utils.amp import custom_fwd, custom_bwd
from viper.src.base_models.maskrcnn_benchmark.utils.shallow_contrastive_loss_helper import *
        ...
        if positive_map is not None and proj_tokens is not None:
            ...
            if shallow_img_emb_feats is not None:
                ...
                if self.cfg.MODEL.DYHEAD.FUSE_CONFIG.USE_BACKBONE_SHALLOW_CONTRASTIVE_LOSS:
                    ...
                    from viper.src.base_models.maskrcnn_benchmark.layers.roi_align import ROIAlignV2
