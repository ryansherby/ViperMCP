...
from viper.src.base_models.maskrcnn_benchmark.data.datasets.evaluation import evaluate, im_detect_bbox_aug
from ..utils.comm import is_main_process
from ..utils.comm import all_gather
from ..utils.comm import synchronize
import pdb
from viper.src.base_models.maskrcnn_benchmark.data.datasets.evaluation.flickr.flickr_eval import FlickrEvaluator
from viper.src.base_models.maskrcnn_benchmark.structures.bounding_box import BoxList
import matplotlib.pyplot as plt
import matplotlib.pylab as pylab
from viper.src.base_models.maskrcnn_benchmark.data.datasets.tsv import load_from_yaml_file
...
def build_lvis_evaluator(ann_file, fixed_ap=True):
    from viper.src.base_models.maskrcnn_benchmark.data.datasets.evaluation.lvis.lvis import LVIS
    from viper.src.base_models.maskrcnn_benchmark.data.datasets.evaluation.lvis.lvis_eval import LvisEvaluatorFixedAP, LvisEvaluator
