...
from viper.src.base_models.maskrcnn_benchmark.modeling.make_layers import conv_with_kaiming_uniform
from viper.src.base_models.maskrcnn_benchmark.layers import DropBlock2D, DyHead
