...
import pdb
# from viper.src.base_models.maskrcnn_benchmark.modeling.detector import build_detection_model
# from viper.src.base_models.maskrcnn_benchmark.utils.checkpoint import DetectronCheckpointer
# from viper.src.base_models.maskrcnn_benchmark.structures.image_list import to_image_list
# from viper.src.base_models.maskrcnn_benchmark import layers as L # only used for L.interpolate ONCE -- try removing
# from viper.src.base_models.maskrcnn_benchmark.modeling.roi_heads.mask_head.inference import Masker
# from viper.src.base_models.maskrcnn_benchmark.utils import cv2_util

from viper.src.base_models.maskrcnn_benchmark.standalone.imagelist import to_image_list
from viper.src.base_models.maskrcnn_benchmark.standalone.masker import Masker
from viper.src.base_models.maskrcnn_benchmark.standalone.serialization import load_state_dict
from viper.src.base_models.maskrcnn_benchmark.standalone import cv2_util
...
from viper.src.base_models.maskrcnn_benchmark.standalone.builder import build_resnet_backbone, build_rpn, build_roi_heads
