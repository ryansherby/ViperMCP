...
from viper.src.base_models.maskrcnn_benchmark.structures.segmentation_mask import SegmentationMask
from viper.src.base_models.maskrcnn_benchmark.data.datasets.coco import has_valid_annotation
